<!-- Inline icon set (Lucide, ISC). Stroke icons drawn with currentColor so they follow the button colour. -->
<script lang="ts">
...
<svg
	...
	focusable="false"
>
	<!-- eslint-disable-next-line svelte/no-at-html-tags -- static, trusted markup from PATHS above -->
	{@html PATHS[name]}
</svg>
